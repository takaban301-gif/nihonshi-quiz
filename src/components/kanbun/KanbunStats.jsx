...
import { KANBUN_CATEGORIES } from '../../utils/subjects'

function KanbunStats({ allQuestions, progress, onBack }) {
  const [tab, setTab] = useState('category')

  const catRows = KANBUN_CATEGORIES.map(cat => {
  ...
  return (
    <div className="stats">
      <div className="stats__header">
        ...
        <span className="stats__title">📊 漢文サマリ</span>
      </div>
